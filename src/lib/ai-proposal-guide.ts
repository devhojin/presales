...
export const AI_PROPOSAL_GUIDE_DESCRIPTION =
  'AI 도구를 활용해 RFP 분석, 요구사항 대응표, 제안서 목차와 본문, 검수, 나라장터 제출까지 따라가는 공공입찰 제안서 작성 실무 가이드입니다.'
...
const AI_PROPOSAL_GUIDE_SEO_META: Record<string, { title: string; description: string }> = {
  'rfp-origin': {
    ...
    description:
      'RFP가 발주 계획, 사전규격, 본공고로 이어지는 흐름을 설명하고 AI로 일정, 준비물, 질의 후보를 정리하는 방법을 안내합니다.',
  },
  ...
  'ai-rfp-analysis': {
    title: 'AI RFP 분석: 과업 범위·요구사항 추출 | AI 제안서 작성법',
    description:
      'AI로 RFP의 과업 범위, 기능·비기능 요구사항, 평가 포인트, 리스크, 질의 후보를 초벌 분석하고 사람이 원문 기준으로 검수하는 방법을 설명합니다.',
  },
  ...
  'ai-draft-writing': {
    ...
    description:
      'AI로 제안서 본문 초안을 빠르게 만들되 과장 표현, 근거 없는 수치, 원문 불일치를 사람이 검수해 공공입찰 문서 품질을 높이는 방법입니다.',
  },
  'proposal-visuals': {
  ...
  'ai-document-operations': {
    title: 'AI로 제안서 자료 정리: 표·체크리스트 자동화 | AI 제안서 작성법',
    description:
      'AI를 활용해 RFP 요구사항 표, 제출 파일 목록, 검수 체크리스트, 반복 문서 작업을 구조화하고 제안서 작성 시간을 줄이는 방법을 설명합니다.',
  },
...
export const AI_PROPOSAL_GUIDE_CATEGORIES: AiProposalGuideCategory[] = [
  ...
  },
  {
    ...
    title: '검수와 제출',
    eyebrow: '09-12',
    description: 'AI 자료 정리, 컨소시엄 역할, 최종 검수, 나라장터 제출 확인까지 마무리합니다.',
    sortOrder: 3,
    isPublished: true,
  },
]
...
const AI_PROPOSAL_GUIDE_SEEDS: AiProposalGuideSeed[] = [
  {
    ...
    aiUse: [
      'AI에 발주 단계별 용어를 정리시키고, 사전규격과 본공고에서 바뀔 수 있는 항목을 표로 비교합니다.',
      'AI에게 일정표 초안을 만들게 한 뒤 담당자 확인, 질의 기간, 내부 리뷰, 가격 검토 마감일을 역산합니다.',
      'AI는 여러 공고 PDF나 메모에서 반복되는 마감일, 제출물, 질의 일정을 표 형태로 정리할 때 활용합니다.',
    ],
    humanCheck: [
  ...
  },
  {
    ...
    aiUse: [
      'AI로 공고문을 요약하되, 참여 가능 여부를 판단하는 항목만 별도 표로 뽑습니다.',
      'AI에게 “탈락 조건”을 먼저 찾게 하면 놓치기 쉬운 제한 조건을 빨리 볼 수 있습니다.',
      'AI를 쓰면 여러 첨부 파일의 파일명, 버전, 제출 양식을 한 목록으로 만들 수 있습니다.',
    ],
    humanCheck: [
  ...
  {
    slug: 'ai-rfp-analysis',
    step: 3,
    title: 'AI로 RFP 초벌 분석하기',
    shortTitle: 'RFP AI 분석',
    description:
      'AI를 활용해 RFP의 과업 범위, 요구사항, 평가 포인트, 리스크를 초벌 분석하고 사람이 검토할 기준을 세웁니다.',
    primaryKeyword: 'AI RFP 분석',
    keywords: ['AI 제안서', 'RFP 분석', 'AI 제안서 작성', '과업 범위 분석', '요구사항 추출'],
    readingMinutes: 9,
    situation: [
  ...
  },
  {
    ...
    aiUse: [
      'AI로 평가항목 순서에 맞춘 목차 초안을 만들고, 각 장의 목적과 필요한 증빙을 붙입니다.',
      'AI에게 요약서 1페이지 흐름을 먼저 만들게 하면 전체 목차의 메시지가 흔들리지 않습니다.',
      'AI는 목차 번호, 파일명, 산출물 목록처럼 반복 정리가 필요한 항목을 일관되게 맞출 때 사용합니다.',
    ],
    humanCheck: [
  ...
  },
  {
    ...
    shortTitle: 'AI 본문 초안',
    description:
      'AI로 제안서 본문 초안을 만들고, 과장 표현과 빈 문장을 제거해 평가자가 읽을 수 있는 문장으로 고치는 방법입니다.',
    primaryKeyword: 'AI 제안서 본문',
    keywords: ['AI 제안서 작성', 'AI 제안서 초안', '제안서 문장', '본문 작성', '제안서 리라이팅'],
    readingMinutes: 9,
    situation: [
    ...
    aiUse: [
      'AI에는 목차, 요구사항, 우리 회사 수행 방식, 금지할 표현을 함께 넣어 초안을 만듭니다.',
      '초안 작성 후에는 AI에게 “근거 없는 문장”, “평가자가 질문할 문장”, “수치가 필요한 문장”을 찾아달라고 요청합니다.',
      'AI는 여러 장의 문체를 통일하거나 표 제목, 그림 캡션, 체크리스트 문구를 정리할 때 활용합니다.',
    ],
    humanCheck: [
  ...
  },
  {
    ...
    nextAction: '다음 단계에서는 AI를 활용해 체크리스트, 표, 반복 문서 작업을 정리합니다.',
  },
  {
    ...
    shortTitle: 'AI 자료정리',
    description:
      'AI를 활용해 요구사항 표, 체크리스트, 파일 목록, 반복 문서 작업을 구조화하고 제안팀의 검수 속도를 높이는 방법입니다.',
    primaryKeyword: 'AI 제안서 자료 정리',
    keywords: ['AI 자료 정리', '제안서 체크리스트', '문서 자동화', '제안서 표 정리', '입찰 자료 정리'],
    readingMinutes: 8,
    situation: [
      '제안서 작성에는 창의적인 문장보다 반복 정리 업무가 많습니다. 파일명 정리, 요구사항 표, 증빙 목록, 검수 체크리스트가 대표적입니다.',
      'AI는 글쓰기뿐 아니라 작업 공간의 파일과 텍스트를 읽고 구조화하는 업무 보조자로 쓸 수 있습니다.',
    ],
    aiUse: [
      '첨부 파일 목록, 목차, 요구사항 표를 AI로 정리하고 누락된 번호나 중복 항목을 찾아냅니다.',
      'Markdown, CSV, JSON처럼 다시 편집하기 쉬운 형식으로 체크리스트를 만들어 팀 공유 자료로 씁니다.',
      '반복되는 표 제목, 캡션, 파일명 규칙을 한 번에 통일합니다.',
    ],
    humanCheck: [
      'AI가 파일을 실제로 읽었는지, 일부만 읽었는지 확인합니다.',
  ...
  },
  {
    ...
    aiUse: [
      'AI로 RFP 제출 조건을 체크리스트로 바꾸고, 각 항목에 담당자와 완료 상태를 붙입니다.',
      'AI로 파일 목록과 제출 조건을 비교해 빠진 파일명이나 중복 파일을 찾습니다.',
  ...
  },
  {
    ...
    aiUse: [
      'AI로 제출 이후 발표 예상 질문과 답변 초안을 만듭니다.',
      'AI로 최종 제출 파일 목록, 제출 시간, 접수 확인 정보를 회고 기록으로 정리합니다.',
...
const AI_PROPOSAL_GUIDE_RICH_BLOCKS: Record<string, AiProposalGuideRichBlock> = {
  ...
  'narajangteo-notice-check': {
    ...
    overview: [
      ...
      'AI 도구 요약은 빠르지만 공고문 숫자와 자격 문구는 한 글자 차이로 의미가 달라집니다. 따라서 AI에는 후보 항목을 뽑게 하고, 최종 판단은 공고 원문과 나라장터 화면을 같이 보며 확정해야 합니다.',
    ],
    workflowRows: [
  ...
  'ai-document-operations': {
    visualCaption: 'AI는 파일 목록, 요구사항 표, 체크리스트를 읽고 반복 문서 작업을 구조화하는 데 적합합니다.',
    overview: [
      '제안서 작업에는 글쓰기보다 정리 업무가 많습니다. 첨부 파일 목록, 요구사항 대응표, 증빙 자료, 파일명 규칙, 최종 검수표는 반복되지만 실수하면 큰 문제가 됩니다.',
      'AI 도구는 작업 폴더의 파일이나 텍스트를 기준으로 구조를 만들 수 있습니다. 다만 어떤 파일을 실제로 읽었는지, 누락된 파일은 없는지 확인하는 절차가 필요합니다.',
    ],
    workflowRows: [
