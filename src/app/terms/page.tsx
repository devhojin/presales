      ...
      <div className="space-y-10 text-sm leading-relaxed text-foreground">
        ...
        <section className="space-y-3">
          ...
          <div className="rounded-lg border border-amber-200 bg-amber-50 p-4 text-amber-900">
            ...
            <p className="mt-1">
              디지털 콘텐츠는 다운로드 또는 열람이 시작되면 단순 변심에 따른 청약철회가 제한될 수 있습니다. 다만 표시·광고 내용과 다르거나 파일 손상 등 하자가 있는 경우에는 관련 법령과 회사 정책에 따라 교환, 재제공 또는 환불을 요청할 수 있습니다.
            </p>
          </div>
          <ol className="list-decimal space-y-2 pl-5 text-muted-foreground">
            <li>디지털 콘텐츠를 다운로드하지 않은 경우 이용자는 결제일로부터 7일 이내에 취소 또는 환불을 요청할 수 있습니다.</li>
            <li>파일이 손상되었거나 상품 설명과 현저히 다른 경우 이용자는 문제 확인을 위해 주문번호, 오류 화면, 파일명 등 필요한 자료를 제출해야 합니다.</li>
