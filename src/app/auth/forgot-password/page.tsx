      ...
      <div className="w-full max-w-md">
        ...
        {sent ? (
          <div className="space-y-6">
            <div className="p-5 bg-green-50 border border-green-200 rounded-lg flex items-start gap-3">
            ...
            <Link
              href="/auth/login"
              className="flex items-center justify-center gap-2 w-full h-11 rounded-lg border border-border text-sm font-medium hover:bg-muted transition-colors cursor-pointer"
            >
