...
const revealStyle = `
  ...
  @keyframes typing-cursor { 0%,100%{border-color:transparent} 50%{border-color:#10b981} }
  ...
  return (
    <>
      ...
      <section className="relative min-h-[100dvh] flex flex-col items-center justify-center bg-[#0a0a0a] text-white overflow-hidden px-6">
        {/* Glow */}
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[600px] h-[600px] rounded-full bg-emerald-500/[0.06]" style={{ filter: 'blur(120px)', animation: 'pulse-glow 8s ease-in-out infinite' }} />
        ...
        <div className="max-w-4xl mx-auto">
          <Reveal className="text-center mb-16">
            <h2 className="text-2xl md:text-4xl font-bold tracking-tight">
              열심히 쓴 제안서가<br />떨어지는 <span className="text-emerald-400">진짜 이유</span>
            </h2>
          </Reveal>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <Reveal key={card.title} delay={card.delay}>
                <div className="bg-white/[0.04] border border-white/[0.08] rounded-2xl p-6 md:p-8 backdrop-blur-sm hover:border-emerald-500/30 transition-colors">
      ...
      <section className="relative min-h-[80vh] md:min-h-[100vh] flex items-center justify-center bg-[#0a0a0a] text-white px-6 overflow-hidden">
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="w-[500px] h-[500px] rounded-full bg-emerald-500/[0.1]" style={{ filter: 'blur(100px)' }} />
        </div>
        <div className="relative z-10 max-w-xl text-center space-y-6">
          <Reveal>
            <p className="text-sm text-emerald-400 font-medium tracking-wider">그런데요,</p>
          </Reveal>
          <Reveal type="scale" delay={300}>
            <h2 className="text-3xl md:text-5xl font-bold tracking-tight leading-tight">
              <span className="text-emerald-400">낙찰받은 제안서</span>는<br />이미 존재합니다.
            </h2>
          </Reveal>
          <Reveal delay={800}>
      ...
      <section className="bg-[#0b0d13] text-white py-24 md:py-32 px-6">
        <div className="max-w-5xl mx-auto">
          <Reveal className="text-center mb-20">
            <p className="text-xs text-emerald-400 font-semibold uppercase tracking-[4px] mb-3">PRESALES</p>
      ...
      <section className="bg-[#0a0a0a] text-white py-24 md:py-32 px-6">
        <div className="max-w-5xl mx-auto">
          <Reveal className="text-center mb-16">
            <p className="text-xs text-emerald-400 font-semibold uppercase tracking-[4px] mb-3">ECOSYSTEM</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {[
              ...
              { icon: Users, title: '전문가 컨설팅', desc: '입찰 전략부터 발표 리허설까지 1:1 코칭. 공공조달 전문가가 낙찰 전략을 함께 짭니다.', href: '/consulting', color: 'from-emerald-500/20 to-emerald-600/10', delay: 300 },
            ].map((item) => (
              <Reveal key={item.title} delay={item.delay}>
                <Link
                  href={item.href}
                  className="block bg-white/[0.03] border border-white/[0.08] rounded-2xl p-6 md:p-8 hover:border-emerald-500/30 hover:-translate-y-1 transition-all duration-300 group"
                >
      ...
      <section className="bg-[#0d0f14] text-white py-24 md:py-32 px-6">
        <div className="max-w-5xl mx-auto">
          <Reveal className="text-center mb-16">
            <p className="text-xs text-emerald-400 font-semibold uppercase tracking-[4px] mb-3">TRACK RECORD</p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
            {[
              ...
              <Reveal key={stat.label} className="text-center">
                <p className="text-3xl md:text-5xl font-bold text-emerald-400 tabular-nums">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <Reveal key={t.name} delay={t.delay}>
                <div className="bg-white/[0.04] border border-white/[0.08] rounded-2xl p-6 hover:border-emerald-500/20 transition-colors">
      ...
      <section className="bg-[#0a0a0a] text-white py-24 md:py-32 px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <Reveal delay={200}>
            <Link
              href="/store"
              className="inline-flex items-center gap-2 h-14 px-10 rounded-full bg-emerald-500 text-white font-semibold text-base hover:bg-emerald-400 transition-all active:scale-[0.98] shadow-[0_0_30px_rgba(16,185,129,0.2)]"
            >
              전체 51개 템플릿 보기
      ...
      <section className="relative min-h-[80vh] md:min-h-[100vh] flex items-center justify-center bg-[#050505] text-white px-6 overflow-hidden">
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="w-[500px] h-[500px] rounded-full bg-emerald-500/[0.05]" style={{ filter: 'blur(120px)' }} />
        </div>
        <div className="relative z-10 max-w-xl text-center space-y-10">
          <Reveal>
            <p className="text-xs text-emerald-400 font-semibold uppercase tracking-[4px]">OUR BELIEF</p>
          </Reveal>
          <Reveal delay={200}>
            <p className="text-xl md:text-2xl lg:text-3xl leading-[1.8] tracking-tight font-medium">
              좋은 기술을 가진 기업이<br />
              제안서 때문에 기회를 잃는 건<br />
              이 시장의 <span className="text-emerald-400 underline underline-offset-4 decoration-emerald-400/50">구조적 불공정</span>입니다.
            </p>
          </Reveal>
          <Reveal delay={600}>
      ...
      {/* ─── ⑨ 최종 CTA ─── */}
      <section className="relative py-24 md:py-32 px-6 overflow-hidden" style={{ background: 'linear-gradient(135deg, #064e3b, #10b981)' }}>
        {/* Noise overlay */}
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center text-white">
          ...
          <Reveal delay={400} className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-10">
            <Link
              href="/store"
              className="h-14 px-10 rounded-full bg-white text-emerald-700 font-bold text-base hover:bg-white/90 transition-all active:scale-[0.98] flex items-center gap-2 shadow-lg"
            >
              제안서 템플릿 둘러보기
              <ArrowRight className="w-5 h-5" />
            </Link>
