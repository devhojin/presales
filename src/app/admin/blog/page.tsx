      ...
      <div className="mb-6">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/40"
          />
        </div>
      </div>
        ...
        <div className="overflow-x-auto border border-gray-200 rounded-xl">
          <table className="w-full">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                <th className="px-5 py-3 text-left text-xs font-semibold text-gray-700">제목</th>
                <th className="px-5 py-3 text-left text-xs font-semibold text-gray-700">카테고리</th>
                <th className="px-5 py-3 text-left text-xs font-semibold text-gray-700">태그</th>
                <th className="px-5 py-3 text-left text-xs font-semibold text-gray-700">작성일</th>
                <th className="px-5 py-3 text-center text-xs font-semibold text-gray-700">조회</th>
                <th className="px-5 py-3 text-center text-xs font-semibold text-gray-700">상태</th>
                <th className="px-5 py-3 text-center text-xs font-semibold text-gray-700">작업</th>
              </tr>
            </thead>
                  ...
                  <td className="px-5 py-3.5 text-center">
                    <div className="flex items-center justify-center gap-1.5">
                      <Link
                        ...
                        className="p-1.5 text-gray-400 hover:text-blue-600 cursor-pointer transition-colors"
                        title="수정"
                      >
