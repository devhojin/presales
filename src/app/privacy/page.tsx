...
const personalDataRows = [
  ...
  },
  {
    category: '이용 기록·분석',
    items:
      '방문 경로, 페이지 경로, 세션 식별자, 장바구니·북마크·쿠폰·다운로드 기록, GA4·Clarity 이벤트 및 이용행태 데이터(설정된 경우)',
...
const outsourcingRows = [
  ...
  },
  {
    ...
    task: '웹 이용행태 분석, 히트맵 및 세션 리플레이(Clarity 프로젝트 ID가 설정된 경우)',
    data: '페이지 경로, 클릭·스크롤 등 이용행태, 기기·브라우저 정보, 쿠키 식별자',
  },
  {
    company: 'Upstash Inc.',
...
const overseasRows = [
  ...
  },
  {
    ...
    items: 'GA4·Clarity 이벤트, 페이지 경로, 클릭·스크롤 등 이용행태, 기기·브라우저 정보, 쿠키 식별자',
    purpose: '서비스 이용 통계, 히트맵, 세션 리플레이 분석',
        ...
        <section id="cookies">
          ...
          <div className="space-y-3 text-muted-foreground">
            ...
            <ol className="list-decimal list-inside space-y-2">
              ...
              <li>분석 쿠키: GA4 또는 Clarity가 설정된 경우 페이지 조회, 상품 조회, 구매, 다운로드, 리뷰 이벤트와 클릭·스크롤 등 이용행태</li>
            </ol>
            <p>
